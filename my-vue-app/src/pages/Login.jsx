          ...
          <div className="w-full flex flex-row p-10 max-[760px]:px-1 max-[760px]:my-2">
            ...
            <div className=" max-[760px]:w-full max-[760px]:rounded-l-lg  flex flex-col justify-center items-center bg-white w-[50%] rounded-r-lg shadow-[0px_20px_20px_10px_#00000030] gap-5 p-10">
              <img
                ...
                alt="logo-eveny"
                className="flex w-38 justify-center"
              />
              <GoogleButton />
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  onBlur={checkMail}
                  type="email"
                  className="bg-gray-200 appearance-none border-2 border-gray-200 rounded-xl py-3 px-5 hover:border-purple-500 active:border-purple-500"
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="bg-gray-200 appearance-none border-2 border-gray-200 rounded-xl py-3 px-5 hover:border-purple-500"
                  placeholder="Inserisci password"
                />
                {errorPassword ? (
                  <span className="text-red-500 inline font-bold text-xs">
              ...
              <button
                className={`${
                  !errorEmail && !errorPassword
                    ? " text-white bg-purple-500 p-5 pointer-events-auto px-4 py-3 rounded-2xl w-[50%] mt-4"
                    : "bg-gray-500 pointer-events-none px-4 py-3 rounded-2xl"
                }`}
              >
                Login
              </button>
